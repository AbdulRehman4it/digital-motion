...
<section class="flex flex-col md:flex-row lg:mt-28 " data-aos="fade-up">
   ...
   <div class="w-full md:w-1/2 h-full p-6 lg:p-12 relative hidden md:block lg:block" data-aos="flip-left">
    ...
    <section class="py-10 lg:py-20 bg-[url('../img/counterbg.png')]" data-aos="fade-up" id="impactSection">
  <div class="flex flex-col items-center text-center" data-aos="fade-up">
  <blockquote class="instagram-media" data-instgrm-permalink="https://www.instagram.com/dynamicmotion.mena" data-instgrm-version="14" style="max-width: 100%; margin: auto;">
</blockquote>
